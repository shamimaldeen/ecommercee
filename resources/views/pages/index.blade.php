                ...
                <div class="col-lg-3 col-md-6 char_col">              
                    <div class="char_item d-flex flex-row align-items-center justify-content-start">
                        ...
                        <div class="char_content">
                            ...
                            <div class="char_subtitle">from Tk 50</div>
                        </div>
                    </div>
                </div>
                                   ...
                                   @foreach($featured as $row) 
                                    ...
                                    <div class="featured_slider_item">
                                        ...
                                        <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                         ...
                                         <img  src="{{ asset($row->image_one) }}" style="height: 120px; width: 130px;">   </a>
                                                
                                                </div>
                                            <div class="product_content">
                                            @if($row->discount_price == NULL)
                                                <br><span class="text-danger"><b> Tk {{ $row->selling_price }} </b></span>
                                            @else
                                ...
                                <div class="trends_item is_new">
                                    ...
                                    <div class="trends_content">
                                        ...
                                        <div class="trends_info clearfix">
                                            ...
                                            {{-- <div class="trends_price">Tk 379</div> --}}
                                            @if($row->discount_price == NULL)
                                                <br><span class="text-danger"><b> Tk {{ $row->selling_price }} </b></span>
                                            @else
                                             <div class="product_price discount">Tk {{ $row->discount_price }}<span>Tk {{ $row->selling_price }}</span></div>
                                        ...
                                        <button id="{{ $row->id }}" class="btn btn-danger btn-sm pull-right addcart" data-toggle="modal" data-target="#cartmodal"  onclick="productview(this.id)">Add to Cart</button>
