                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-sm-3 col-3 order-1">
                        <div class="logo_container">
                             <img src="{{ asset($setting->logo) }}" style="width:70%; max-width:200px; height: 60%;">
                          <a href="{{ url('/') }}" style="color: #404040b5;
    font-size: 20px;
    font-family: fantasy;
                            ...
                            <div class="cart">
                                <div class="cart_container d-flex flex-row align-items-center justify-content-end">
                                    ...
                                    <div class="cart_content">
                                        ...
                                        <div class="cart_price">Tk {{ Session::get('coupon')['balance'] + $charge }} </div>
                                        @else
